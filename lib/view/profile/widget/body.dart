...
class _BodyProfileState extends State<BodyProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(  // Wrap the entire layout in a SingleChildScrollView
      child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: statusCurrentIndex == index ? status.selectColor : status.unSelectColor,
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                status.txt,
                                style: TextStyle(fontWeight: FontWeight.w600, color: AppConstantsColor.lightTextColor, fontSize: 16),
                              ),
                            ],
                          ),
                        ),
              ...
              trailing: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      "2 New",
                      style: TextStyle(color: AppConstantsColor.lightTextColor, fontWeight: FontWeight.w500),
                    ),
                    Icon(Icons.arrow_forward_ios, color: AppConstantsColor.lightTextColor, size: 15),
                  ],
                ),
              ),
            ),
            RoundedLisTile(
              ...
              trailing: Container(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Icon(Icons.arrow_forward_ios, color: AppConstantsColor.darkTextColor, size: 15),
                  ],
                ),
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontWeight: FontWeight.w600, color: Colors.blue[600], fontSize: 17),
            ),
            SizedBox(height: 40),
            Text(
              "    Log Out",
              style: TextStyle(fontWeight: FontWeight.w600, color: Colors.red[500], fontSize: 18),
            ),
          ],
        ),
      ),
