...
class _BodyBagViewState extends State<BodyBagView> with SingleTickerProviderStateMixin {
  ...
  mainListView(width, height) {
    return Container(
      width: width,
      height: height / 2, // Reduce fixed height for ListView
      child: ListView.builder(
        shrinkWrap: true,  // Let ListView take only the necessary space
